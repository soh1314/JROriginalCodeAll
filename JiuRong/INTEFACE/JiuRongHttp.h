...
static NSString* SERVE_ROOT     =       @"http://192.168.1.123:9000";
static NSString* SERVE_PATH     =       @"http://192.168.1.123:9000/app/services";
static NSString* IMAGE_PATH =           @"http://192.168.1.123:9000/FileUpload/uploadNoFile";
static NSString* CERTIFY_INFO =         @"http://192.168.1.123:9000/app/services";
static NSString* PROTOCOL =             @"http://192.168.1.123:9000/appAgreement";
static NSString * VEDIO_PATH    =       @"http://192.168.1.123:9000/FileUpload/uploadApp";
#else
