...
#import "ViewController_WithdrawCash.h"
#import "Public.h"
#import "UserInfo.h"
...
@interface ViewController_WithdrawCash ()
{
    UIWebView *m_pWebviewHuihu;
}
@end

@implementation ViewController_WithdrawCash
 ...
 */
    NSString *url = [JiuRongHttp JRWithdrawCash:[UserInfo GetUserInfo].uid];
